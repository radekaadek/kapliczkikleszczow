...
export default {
  ...
  mounted() {
        ...
        qe =
          (B.include({
            ...
            O.extend({
              ...
              addTo: function (t) {
                return (
                  O.prototype.addTo.call(this, t), this._expandIfNotCollapsed()
                );
              },
              onRemove: function () {
        ...
        ci = et.extend({
          ...
          _setIconStyles: function (t, e) {
            ...
            (t.className = "leaflet-marker-" + e + " " + (i.className || "")),
              ...
              n &&
              ((t.style.width = n.x + "px"), (t.style.height = n.y + "px"));
          },
      ...
      var yi = vi.extend({
        ...
        _convertLatLngs: function (t) {
          var t = vi.prototype._convertLatLngs.call(this, t),
            e = t.length;
          return (
            2 <= e && t[0] instanceof v && t[0].equals(t[e - 1]) && t.pop(), t
          );
        },
        _setLatLngs: function (t) {
      ...
      function wi(t, e) {
        ...
        switch (r.type) {
          ...
          case "MultiLineString":
            return (
              (n = Li(a, "LineString" === r.type ? 0 : 1, u)), new vi(n, e)
            );
          case "Polygon":
          case "MultiPolygon":
    ...
    function popContentGenerator(e) {
      ...
      mail_info.classList.add('invisible');
      ...
      button.addEventListener('click', () => {
        ...
        if (emailRegex.test(email.value) && email.value.length > 0 && message.value.length > 0 && name.value.length > 0) {
          ...
          mail_info.classList.remove("invisible");
...
.butonik {
  ...
  background-color: rgb(116, 181, 10);
  border-radius: 6px;
  border-width: 0;
  cursor: pointer;
  font-size: 100%;
